...
1. 카메라의 큰 중앙 가이드 안에 카드가 들어오도록 맞춥니다.
...
현재 스캐너는 OpenCV 외곽선 추적을 사용하지 않습니다. 실험 결과 탑로더, 슬리브 반사, 일러스트 박스 같은 사각형을 카드 외곽으로 오인해 오히려 인식률과 안정성이 떨어졌기 때문에, 안정적인 중앙 가이드 crop 기반 흐름으로 복원했습니다.
